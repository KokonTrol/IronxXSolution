...
namespace ApexCheckUpdate
{
    public static class CheckGameUpdate
    {
        private static string _link = @"https://steamdb.info/api/PatchnotesRSS/?appid=1172470";
        public static string GameName() { return "Apex Legends"; }
