...
namespace CODCheckUpdate
{
    public static class CheckGameUpdate
    {
        private static string _link = @"https://steamdb.info/api/PatchnotesRSS/?appid=2000950";
        public static string GameName() { return "Call of Duty: Modern Warfare"; }
