...
namespace CSGOCheckUpdate
{
    public static class CheckGameUpdate
    {
        private static string _link = @"https://steamdb.info/api/PatchnotesRSS/?appid=730";
        public static string GameName() { return "Counter-Strike: Global Offensive"; }
        ...
        private static async Task<DateTime> LoadPage()
        {
            try
            {
                HttpClient _client;
