...
namespace WorldOfTanksCheckUpdate
{
    public static class CheckGameUpdate
    {
        private static string _link = @"https://steamdb.info/api/PatchnotesRSS/?appid=1407200";

        public static string GameName() { return "World Of Tanks"; }
